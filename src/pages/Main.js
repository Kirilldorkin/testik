          ...
          <div className="cryptocurrency-block">
            ...
            <div class="invisible-ellipse"></div>
              ...
              <p>
                ...
                <br /> <br />
                here are 8 popular cryptocurrency pairs available on our
                platform.
                <br /> <br />
          ...
          <div className="instruction">
            <div className="instruction-text">
              ...
              <p className="instruction-description">
                Build your business: become an agent and earn monthly. Your
                income depends on you and only you!
              </p>
            </div>
          ...
          <div className="instruction">
            <div className="instruction-text">
              ...
              <p className="instruction-description">
                ...
                <br /> <br />
                Being a MostBet Cash agent means having an opportunity of
                earning a lot.
              </p>
              <div class="invisible-ellipse"></div>
            </div>
            ...
            <div className="image-container">
              <img src={Crypto01} alt="img" className="crypto crypto-1" />
            </div>
          </div>

          <div className="instruction reverse">
            <div className="image-container">
              <img src={Crypto02} alt="img" className="crypto" />
            </div>

            <div className="instruction-text">
              <h2 className="instruction-border">HOW DOES IT WORK?</h2>
              <p className="instruction-description">
